...
export default async function CompetitorsPage({
  ...
  return (
    <EntityListScreen
      ...
      listSegment="competitors"
      listQuery={parseEntityListQuery(await searchParams)}
      lockedType="competitor"
      title="Competitors"
      description="Named rivals, substitutes, and adjacent players your GTM and product teams should never lose sight of."
    />
  );
}
